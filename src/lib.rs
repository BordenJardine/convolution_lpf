...
impl Default for LowPassFilterVst {
    fn default() -> Self {
...
impl Plugin for LowPassFilterVst {
    ...
    fn get_info(&self) -> Info {
        ...
        const UNIQUE_ID_SEED: &str = "LowPass Filter VST2 Plugin";
...
vst::plugin_main!(LowPassFilterVst);
